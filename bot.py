...
class MusicBot(discord.Client):
    ...
    async def on_ready(self):
        ...
        print("Afternoon BVS, I edited the script to where you can use it. We need this part, and the log in part.")
        print()
    ...
    async def on_message(self, message):
        ...
        if message.channel.is_private:
            await self.send_message(message.channel, 'Sorry we are during construction, come back later!')
            return
